...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        //Setari pentru control iluminare buton2
        

        //Setari pentru a doua sursa de iluminare
        ...
        private void SetupWindowGUI() {
            ...
            // Adăugat pentru sursa de lumină 1
        ...
        {
            numericLight1Ambient_Red.Value = (decimal)valuesAmbient1[0];
            numericLight1Ambient_Green.Value = (decimal)valuesAmbient1[1];
            numericLight1Ambient_Blue.Value = (decimal)valuesAmbient1[2];
        }
        ...
        //Activam/dezactivam sursa de iluminare 1
        ...
        //Schimbam pozitia sursei 1 de iluminare dupa axele XYZ
      ...
      /*  //Schimbăm culoarea sursei de lumină 1 (specular) în domeniul RGB.
        ...
        {
            numericLight1Specular_Red.Value = (decimal)valuesSpecular1[0];
            numericLight1Specular_Green.Value = (decimal)valuesSpecular1[1];
            numericLight1Specular_Blue.Value = (decimal)valuesSpecular1[2];
        }
...
*/
        ...
        //Resetare stare sursa de lumina nr 1
       /* private void setLight1Values()
        {
            // Valorile implicite pentru sursa de lumină 1
            float[] valuesAmbientTemplate1 = new float[] { 0.1f, 0.1f, 0.1f, 1.0f };
            float[] valuesDiffuseTemplate1 = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
            float[] valuesSpecularTemplate1 = new float[] { 0.1f, 0.1f, 0.1f, 1.0f };
            float[] valuesPositionTemplate1 = new float[] { 0.0f, 0.0f, 5.0f, 1.0f };
...
*/
       /* private void btnLight1Reset_Click(object sender, EventArgs e)
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            //Se creeaza sursa de iluminare. In acest caz folosim o doua surse.
